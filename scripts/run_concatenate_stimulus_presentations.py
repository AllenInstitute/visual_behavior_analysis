...
python_file = r"/home/marinag/visual_behavior_analysis/scripts/concatenate_stimulus_presentations.py"
...
for project_code in experiments_table.project_code.unique():
    for session_number in experiments_table.session_number.unique():
        ...
        PythonJob(
            ...
            conda_env=None,
            jobname='stimulus_presentations_'+project_code+'_'+str(session_number),
            **job_settings
        ).run(dryrun=False)
