...
if __name__ == '__main__':
    ...
    ### just plot the matched ROIs with their omission and change aligned traces for F, N, N'
    ...
    # glm_output_folder = '220606_test_4x2'
    ...
    # experiments_table = loading.get_platform_paper_experiment_table(include_4x2_data=True, add_extra_columns=True, limit_to_closest_active=True)
