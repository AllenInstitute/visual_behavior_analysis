...
indexes = ['cre_allPlanes', 'mouse_id_allPlanes', 'area_allPlanes', 'depth_allPlanes', 'session_labs', \
...
svm_allMice_sessPooled = pd.Series([cre_all, mouse_id_all, area_all, depth_all, session_labs_all, \
