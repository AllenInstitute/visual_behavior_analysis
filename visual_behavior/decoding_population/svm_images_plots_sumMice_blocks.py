...
whichStages = [5,6] #[1,2] #[3,4] #[1,3,4,6] # stages to plot on top of each other to compare
...
#         print(x+xgap)
        ...
        ax2.errorbar(xnow, top[inds_lm, 1], yerr=top_sd[inds_lm, 1], fmt=fmt_now, markersize=5, capsize=0, label=f'ophys{stagenow}')
        # shuffle
