...
import visual_behavior.data_access.loading as loading # the VBA data_access module provides useful functions for identifying and loading experiments to analyze. 
...
#%% Get experiments from a certain project

project2an = 'all' # 'VisualBehavior', 'VisualBehaviorMultiscope', 'VisualBehaviorMultiscope4areasx2d', 'VisualBehaviorTask1B'

# print the number of experiments from each project
print(experiments_table['project_code'].value_counts())

# all_project_codes = np.unique(experiments_table['project_code'].values)
# a = [sum(experiments_table['project_code'].values == p2a) for p2a in all_project_codes]
# print(all_project_codes)
# print(a)
...
if project2an != 'all':
    ...
    experiments_table_2an = experiments_table[a==project2an]
else: 
    experiments_table_2an = experiments_table
...
#%% Get the 1st novel session

#%% For each experiment set trial-average omission-aligned traces.


####################################################
#%% Load the file that was already saved
...
# name = 'all_sess_omit_traces_peaks_allTraces_sdk_20200620_234127.pkl'
