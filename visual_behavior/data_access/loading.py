...
class BehaviorOphysDataset(BehaviorOphysSession):
    ...
    def extended_stimulus_presentations(self):
        ...
        stimulus_presentations.at[stimulus_presentations.index.values[1:], 'lick_on_next_flash'] = stimulus_presentations.licked.values[:-1]
        stimulus_presentations.at[stimulus_presentations.index.values[1:], 'lick_rate_next_flash'] = stimulus_presentations.lick_rate.values[:-1]
        stimulus_presentations = reformat.add_epoch_times(stimulus_presentations)
