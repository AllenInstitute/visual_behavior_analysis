...
#%%
def svm_main_pbs(session_id, experiment_ids, validity_log_all, dir_svm, frames_svm, numSamples, saveResults, use_ct_traces, same_num_neuron_all_planes=0):
...
svm_main_pbs(session_id, experiment_ids, validity_log_all, dir_svm, frames_svm, numSamples, saveResults, use_ct_traces, same_num_neuron_all_planes)	
