...
python_file = r"/home/jeromel/Documents/Projects/Deep2P/repos/deepinterpolation/examples/2020-01-20-1p_training.py"

now = datetime.datetime.now()
run_uid = now.strftime("%Y_%m_%d_%H_%M")
jobdir = '/allen/programs/braintv/workgroups/neuralcoding/Neuropixels_Data/1p/cluster/'
