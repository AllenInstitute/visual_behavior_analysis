...
def get_all_mesoscope_data():
    query = ("select os.id as session_id, oe.id as experiment_id, "
             ...
             "where (p.code = 'MesoscopeDevelopment' or p.code = 'VisualBehaviorMultiscope' or p.code = 'VisualBehaviorMultiscope4areasx2d' ) and os.workflow_state ='uploaded' " # and (oe.workflow_state = 'processing' or oe.workflow_state = 'qc') and os.workflow_state ='uploaded' "
             "order by session_id")
