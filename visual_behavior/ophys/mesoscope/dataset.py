...
def get_all_mesoscope_data():
    query = ("select os.id as session_id, oe.id as experiment_id, "
             ...
             "where (p.code = 'VisualBehaviorMultiscope' or p.code = 'VisualBehaviorMultiscope4areasx2d' or p.code = 'MesoscopeDevelopment') and os.workflow_state ='uploaded' "
             "order by session_id")
...
class MesoscopeDataset(object):
    ...
    def register_rois_to_full_fov(self):
