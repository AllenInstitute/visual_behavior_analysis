...
def test_get_lims_done_sessions():
    ...
    print(f'lims done: {len(lims_done)}')
    print(f'lims_not_done: {len(lims_not_done)}')
    print(f'ica_success: {len(ica_success)}')
...
def test_get_ica_done_sessions():
    ...
    print(f'lims done: {len(ica_done)}')
    print(f'lims_not_done: {len(ica_not_done)}')
    print(f'ica_success: {len(meso_data)}')
