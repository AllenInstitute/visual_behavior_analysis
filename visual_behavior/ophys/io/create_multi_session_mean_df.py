...
def get_multi_session_mean_df(experiment_ids, cache_dir,
                              ...
                              flashes=False, use_events=False, omitted=False, get_reliability=False, save_folder=None):
    ...
    if save_folder == None:
        save_folder = 'tmp'
    mega_mdf_write_dir = os.path.join(cache_dir, 'multi_session_summary_dfs', save_folder)
...
if __name__ == '__main__':
    ...
    experiment_ids = [775614751, 778644591, 783927872, 783928214, 784482326, 787498309,
                      ...
                      796106321, 796106850, 796108483, 796306417, 796308505,
