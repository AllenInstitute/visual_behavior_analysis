...
def create_analysis_files(experiment_id, cache_dir, overwrite_analysis_files=True):
    ...
    for cell in dataset.get_cell_indices():
        ...
        sf.plot_mean_response_by_repeat(analysis.flash_response_df, cell, save_dir=dataset.analysis_dir)
        sf.plot_mean_response_by_image_block(analysis.flash_response_df, cell, save_dir=dataset.analysis_dir)
    logger.info('done')
