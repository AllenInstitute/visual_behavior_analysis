...
def create_analysis_files(experiment_id, cache_dir, overwrite_analysis_files=True):
    ...
    for cell_roi_id in dataset.cell_roi_ids:
        sf.plot_image_response_for_trial_types(analysis, cell_roi_id, save=True)
        sf.plot_cell_summary_figure(analysis, cell_roi_id, save=True, show=False, cache_dir=cache_dir)
