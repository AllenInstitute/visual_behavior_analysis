...
def plot_average_image_for_experiment(ophys_experiment_id, ax=None):
    ...
    ax.imshow(average_image, cmap='gray', vmax=np.percentile(average_image, 99))
    ax.axis('off')
    return ax
...
def plot_motion_correction_average_image_for_experiment(ophys_experiment_id, ax=None):
    ...
    ax.imshow(average_image, cmap='gray', vmin=0, vmax=bitdepth_16 * .4)
    ax.axis('off')
    return ax
...
def plot_motion_correction_max_image_for_experiment(ophys_experiment_id, ax=None):
    ...
    ax.imshow(max_image, cmap='gray', vmin=0, vmax=bitdepth_16 * .6)
    ax.axis('off')
    return ax
