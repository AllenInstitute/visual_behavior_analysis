...
parser.add_argument(
    "--ots",
    help="""Don't normalize timestamps.  This option causes timestamps to be
...
parser.add_argument(
    "--all",
    help="Output all records even if no signals changed",
    action="store_true",
    dest="output_all"
)
...
parser.add_argument(
    "--ofn",
    help="Output original frame number instead of incrementing with the sync signal.",
    action="store_true"
)
...
parser.add_argument(
    "--sync",
    help="Output the sync signal",
    action="store_true"
)
parser.add_argument(
    "--trigger",
    help="Output the trigger signal",
    action="store_true"
)
parser.add_argument(
    "--io1",
    help="Output the gpio1 signal",
    action="store_true"
)
parser.add_argument(
    "--io2",
    help="Output the gpio2 signal",
    action="store_true"
)
